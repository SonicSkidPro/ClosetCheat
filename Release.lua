...
getgenv().AutoMacro = false
getgenv().Macro = false
getgenv().AutoMacroKey = Enum.KeyCode.Z
getgenv().MacroKey = Enum.KeyCode.P
        ...
        if input.UserInputType == Enum.UserInputType.Keyboard then
            ...
            if input.KeyCode == MacroKey then
                ...
                if not MacroToggle then
                    ...
                    MacroToggle = true
                    spawn(function()
                        if getgenv().Athena.Misc.MacroType == "Keyboard" then
                        ...
                        elseif getgenv().Athena.Misc.MacroType == "Mouse" then
                            while MacroToggle == true do
                                wait()
                                game:GetService("VirtualInputManager"):SendMouseWheelEvent("0", "0", true, game)
                                wait()
...
if getgenv().Athena.Misc.LegitMacro == true then
    game:GetService("UserInputService").InputBegan:Connect(function(input, chatting)
        if input.UserInputType == Enum.UserInputType.Keyboard then
            if chatting then
                IsChatting = true
            ...
            if input.KeyCode == GodMacroKey then
                ...
                if not getgenv().Athena.Misc.LegitMacro then
                    if Notification == true then
                        game.StarterGui:SetCore("SendNotification", {
                            Title = "GodMacro";
                            Text = "GodMacro: On";
                    ...
                    getgenv().Athena.Misc.LegitMacro = true
                    ...
                    spawn(function()
                        if getgenv().Athena.Misc.MacroType == "Keyboard" then
                            while getgenv().Athena.Misc.LegitMacro == true do
                    ...
                    if Notification == true then
                        ...
                        getgenv().Athena.Misc.LegitMacro = false
                        if GodMacroAuto == true then
                            local Greet = game.ReplicatedStorage.ClientAnimations.Greet
                            local Humanoid = game.Players.LocalPlayer.Character.Humanoid
                            local Animation = Humanoid:LoadAnimation(Greet)
